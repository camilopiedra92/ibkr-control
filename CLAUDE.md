...
| Phase | Status | Plan |
|---|---|---|
| 1. Foundation | 📋 plan escrito, sin ejecutar | `docs/plans/2026-05-24-ibkr-control-phase1-foundation.md` |
| 2. Data ingestion | ⏳ por planificar | — |
| 3. Domain layer + lotes | ⏳ por planificar | — |
| 4. Simulador (STK + FUT) | ⏳ por planificar | — |
| 5. Dividendos + Patrimonio + Form 160 + Reporte | ⏳ por planificar | — |
| 6. Polish (yfinance + composición + multi-year) | ⏳ por planificar | — |
