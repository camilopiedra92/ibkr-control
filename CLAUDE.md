...
- **⏯ SIGUIENTE (próxima sesión) — SP2 (Authorization):** account-multihome quedó implementado (PR pending merge); la semántica de tenancy ya es definitiva. Arrancar SP2 sobre `main` post-merge — ver el bullet "SIGUIENTE — SP2" abajo.
