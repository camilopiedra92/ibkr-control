...
async def _seed_creds(client: AsyncClient, auth_headers_with_org: dict) -> None:
...
async def test_step2_detect_400_when_no_creds(client: AsyncClient, auth_headers_with_org: dict):
